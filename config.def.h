...
static Key keys[] = {
	...
	{ MODKEY,                       XK_t,      setlayout,      {.lt = tile } },     /* Use the tile layout function */
	{ MODKEY,                       XK_f,      setlayout,      {.lt = NULL } },     /* Use no layout function (floating) */
	{ MODKEY,                       XK_m,      setlayout,      {.lt = monocle } },  /* Use the monocle layout function */
